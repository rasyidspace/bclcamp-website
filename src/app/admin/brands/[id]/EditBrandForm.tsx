...
import { updateBrand } from "@/app/actions/admin"
    ...
    <div className="rounded-lg border bg-card shadow-sm p-6 max-w-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <input required name="name" defaultValue={brand.name} type="text" className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
        </div>
